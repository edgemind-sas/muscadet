...
import muscadet.kb.hydrolic as hydr

# Global Class
# ===============
class Climatisation(muscadet.ObjFlow):
...
my_rbd.add_component(cls="Climatisation", name="clim")
...
# Connect components
my_rbd.auto_connect("S1", "clim")
my_rbd.auto_connect("P1", "clim")
